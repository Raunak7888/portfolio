...
const Navbar = () => {
    return (
        <div
            className='w-[90vw] sticky top-[4vh] h-[7vh] rounded-3xl flex justify-between items-center font-syne text-white bg-[#4c4c4c80] px-[2%]'
        >
            {/* Left: Brand Name */}
            ...
            <div className="flex items-center gap-6">
                ...
                {/* Icons */}
                <button className="w-10 h-10 hover:scale-110 transition">
